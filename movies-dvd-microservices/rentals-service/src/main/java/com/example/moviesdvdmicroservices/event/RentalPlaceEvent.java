...
public class RentalPlaceEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2461398146860417871L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RentalPlaceEvent\",\"namespace\":\"com.example.moviesdvdmicroservices.event\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"firstname\",\"type\":\"string\"},{\"name\":\"lastname\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"status\",\"type\":\"string\"},{\"name\":\"days\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"}]}");
   ...
   */
  public RentalPlaceEvent(java.lang.CharSequence id, java.lang.CharSequence firstname, java.lang.CharSequence lastname, java.lang.CharSequence email, java.lang.CharSequence status, java.lang.CharSequence days, java.lang.CharSequence price) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: days = (java.lang.CharSequence)value$; break;
    case 6: price = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RentalPlaceEvent>
    ...
    private Builder(com.example.moviesdvdmicroservices.event.RentalPlaceEvent.Builder other) {
      ...
      if (isValidValue(fields()[5], other.days)) {
        this.days = data().deepCopy(fields()[5].schema(), other.days);
    ...
    public RentalPlaceEvent build() {
      try {
        ...
        record.days = fieldSetFlags()[5] ? this.days : (java.lang.CharSequence) defaultValue(fields()[5]);
        record.price = fieldSetFlags()[6] ? this.price : (java.lang.CharSequence) defaultValue(fields()[6]);
        return record;
