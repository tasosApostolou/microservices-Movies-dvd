...
//
//@Component
//public class AuthCustomerFilter extends AbstractGatewayFilterFactory<AuthCustomerFilter.Config> {
//
//    @Autowired
...
//                    .header("Auth", "Bearer " + token) // You can choose what to put here
//                    .build();
